...
module-whatis   "$NAME $VERSION : See https://github.com/SouthAfricaDigitalScience/OpenMPI-deploy"
setenv       OPENMPI_VERSION       $VERSION
setenv       OPENMPI_DIR           $::env(CVMFS_DIR)/$::env(SITE)/$::env(OS)/$::env(ARCH)/$NAME/$VERSION
